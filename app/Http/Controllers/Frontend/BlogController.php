...
class BlogController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.blog.index', compact( 'blogs', 'site_info', 'google_analytic',
            'socials', 'breadcrumb', 'sponsors', 'contact_section', 'contacts', 'pages', 'color_option'));
    }
    ...
    public function show($slug)
    {
        ...
        return view('frontend.blog.show', compact('blog', 'blog_count_categories', 'comments',
            ...
            'breadcrumb', 'contact_section', 'contacts', 'pages', 'color_option'));
    }
    ...
    public function category_show($category_name)
    {
        ...
        return view('frontend.blog.category-show', compact('blogs', 'category',
            ...
            'sponsors', 'contact_section', 'contacts', 'pages', 'color_option'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('frontend.blog.search-index', compact ('blogs',
            'site_info', 'google_analytic', 'socials', 'breadcrumb', 'sponsors',
              'contact_section', 'contacts', 'pages', 'color_option'));
    }


     public function show_new_slug($slug)
    {
          // Get site language
        $language = getSiteLanguage();
        ...
        return view('frontend.news.new', compact('blog', 'blog_count_categories', 'comments',
            'recent_posts','site_info', 'google_analytic', 'socials',
            'breadcrumb', 'contact_section', 'contacts', 'pages', 'color_option'));
    }


     public function operation($slug_new){
            // Get site language
        $language = getSiteLanguage();
        ...
        // Get comments
           $category = Category::where('categories.category_slug', '=', $slug_new)->first()
            ->get();
        ...
        return view('frontend.operations.operation', compact('category', 'recent_posts'));
    }
