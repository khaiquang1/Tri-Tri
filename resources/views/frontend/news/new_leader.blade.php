  ...
  <section class="news-detail">
    <div class="row flex flex-wrap">
      <div class="col-xs-12 col-md-8 col-lg-9">
        ...
        <h1 class="title-page">{{ $new_leaders->title }}</h1>
       <time class="time-news">{{ Carbon\Carbon::parse($new_leaders->created_at)->isoFormat('DD') }} {{ Carbon\Carbon::parse($new_leaders->created_at)->isoFormat('MMM') }} {{ Carbon\Carbon::parse($new_leaders->created_at)->isoFormat('GGGG') }}</time>
       ...
       <!--  <div class="share">
        ...
        <div class="full-content">
          ...
          @php echo html_entity_decode($new_leaders->desc); @endphp
          <br>

        

          <a href="{{ $new_leaders->btn_link }}">{{ $new_leaders->btn_link }} </a>
  </div>
      </div>
