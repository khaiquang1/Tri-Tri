...
@section('title')
<title>Tuyển dụng - Công ty cổ phần Trí Tri</title>
@endsection
 ...
 <div id="ctl00_divAlt1" class="altcontent1 cmszone">
  ...
  <div class="item">
    <img src="{{asset('assets/frontend/image/banner_page.png')}}" alt="">
            ...
            <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="#" class="itemcrumb active" itemprop="url"><span itemprop="title">Tuyển dụng</span></a></li>
  ...
  <section class="news-detail">
    <div class="row flex flex-wrap">
      ...
      <div class="col-xs-12 col-md-8 col-lg-9">
        ...
        <div class="share">
          <div class="face-like"><a class="fb-like fb_iframe_widget" data-href="http://www.tritri.org/linh-vuc-hoat-dong/hr-search-selection/tong-quan-tri-tri-talent-search-selection-s-s-1" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false" fb-xfbml-state="rendered" fb-iframe-plugin-query="app_id=766305180482770&amp;container_width=0&amp;href=http%3A%2F%2Fwww.tritri.org%2Flinh-vuc-hoat-dong%2Fhr-search-selection%2Ftong-quan-tri-tri-talent-search-selection-s-s-1&amp;layout=button_count&amp;locale=en_US&amp;sdk=joey&amp;send=false&amp;show_faces=false&amp;width=100"><span style="vertical-align: bottom; width: 90px; height: 28px;"><iframe name="f34e63f307d3514" width="100px" height="1000px" data-testid="fb:like Facebook Social Plugin" title="fb:like Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="{{asset('assets/frontend/like.html')}}" style="border: none; visibility: visible; width: 90px; height: 28px;" class=""></iframe></span></a></div>
          <div class="fb-share-button fb_iframe_widget" data-layout="button_count" fb-xfbml-state="rendered" fb-iframe-plugin-query="app_id=766305180482770&amp;container_width=0&amp;href=http%3A%2F%2Fwww.tritri.org%2Flinh-vuc-hoat-dong%2Fhr-search-selection&amp;layout=button_count&amp;locale=en_US&amp;sdk=joey"><span style="vertical-align: bottom; width: 77px; height: 20px;"><iframe name="f2b52c7c5660c5" width="1000px" height="1000px" data-testid="fb:share_button Facebook Social Plugin" title="fb:share_button Facebook Social Plugin" frameborder="0" allowtransparency="true" allowfullscreen="true" scrolling="no" allow="encrypted-media" src="{{asset('assets/frontend/share_button.html')}}" style="border: none; visibility: visible; width: 77px; height: 20px;" class=""></iframe></span></div>
          <div class="tweet"><iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="twitter-share-button twitter-share-button-rendered twitter-tweet-button" style="position: static; visibility: visible; width: 60px; height: 20px;" title="Twitter Tweet Button" src="{{asset('assets/frontend/tweet_button.0edc1ef9f8b82d9b79c6115bda79f63f.vi.html')}}" data-url="http://www.tritri.org/linh-vuc-hoat-dong/hr-search-selection/tong-quan-tri-tri-talent-search-selection-s-s-1"></iframe></div>
          <div class="google"><div id="___plusone_0" style="position: absolute; width: 450px; left: -10000px;"><iframe ng-non-bindable="" frameborder="0" hspace="0" marginheight="0" marginwidth="0" scrolling="no" style="position:absolute;top:-10000px;width:450px;margin:0px;border-style:none" tabindex="0" vspace="0" width="100%" id="I0_1616545051092" name="I0_1616545051092" src="{{asset('assets/frontend/fastbutton.html')}}" data-gapiattached="true"></iframe></div><div class="g-plusone" data-size="medium" data-count="true" data-href="http://www.tritri.org/linh-vuc-hoat-dong/hr-search-selection/tong-quan-tri-tri-talent-search-selection-s-s-1" data-gapiscan="true" data-onload="true" data-gapistub="true"></div></div>
        </div>
        @if (!empty($page->breadcrumb_image))
                 <figure>
                        <img src="{{ asset('uploads/img/general/'.$page->breadcrumb_image) }}" class="img-full" alt="blog image" >
                     @else
                        <br>
                 @endif
        <div class="full-content">
        @php echo html_entity_decode($page->desc)  @endphp
