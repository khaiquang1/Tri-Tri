...
//Menu
Route::get('/about-us', [\App\Http\Controllers\Frontend\HomeController::class, 'about_us']);//add
Route::get('/fields-of-operation', [\App\Http\Controllers\Frontend\HomeController::class, 'services']);//add
Route::get('/news', [\App\Http\Controllers\Frontend\HomeController::class, 'news_list']);//add
